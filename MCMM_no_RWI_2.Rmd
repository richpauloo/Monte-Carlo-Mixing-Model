...
t3 <- cbind.data.frame(t1, data.frame(x = " "), t2)
t3$time <- stringr::str_sub(t3$time, 5,10)

library(kableExtra); library(knitr)
kable(t3, "latex", caption = "Values reported are TDS ($mg/L$) unless otherwise noted.") %>% 
  add_header_above(c(" " = 2, "No rock-water interactions" = 2,  "Rock-water interactions present" = 2)) 
