...
library(dplyr)
boundary_dat <- readRDS("boundary_dat.rds")
...
ggsave(p, filename = "C:/Users/rpauloo/Documents/GitHub/Monte-Carlo-Mixing-Model/p_sim.pdf", 
       device = cairo_pdf, height = 5, width = 7)
```
...
# save
ggsave("p_ec.pdf", p2, height= 4, width = 7, device = cairo_pdf)
```
...
ggsave("p_salt_budget.pdf", p3, height= 4, width = 7, device = cairo_pdf)
```
