...
bd <- boundary_dat %>% dplyr::select(x,y) %>% mutate(x = abs(x)) %>% arrange(x) %>% as.matrix()
```
...
annual_fluxes$TDS = c(0,35,35,35,35,35,0,35) # TDS
...
plot2
#ggsave("plot2.PNG", plot2, height= 4, width = 7, dpi = 300)
```
